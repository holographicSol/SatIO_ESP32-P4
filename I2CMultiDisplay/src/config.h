...
// ----------------------------------------------------------------------------------------
#define ADMPLEX_0_S0 18
#define ADMPLEX_0_S1 19
#define ADMPLEX_0_S2 23
#define ADMPLEX_0_S3 5
#define ADMPLEX_0_SIG 13
...
#define INDEX_ADMPLEX_CH_0 0
#define INDEX_ADMPLEX_CH_1 1
#define INDEX_ADMPLEX_CH_2 2
#define INDEX_ADMPLEX_CH_3 3
#define INDEX_ADMPLEX_CH_4 4
#define INDEX_ADMPLEX_CH_5 5
#define INDEX_ADMPLEX_CH_6 6
#define INDEX_ADMPLEX_CH_7 7
#define INDEX_ADMPLEX_CH_8 8
#define INDEX_ADMPLEX_CH_9 9
#define INDEX_ADMPLEX_CH_10 10
#define INDEX_ADMPLEX_CH_11 11
#define INDEX_ADMPLEX_CH_12 12
#define INDEX_ADMPLEX_CH_13 13
#define INDEX_ADMPLEX_CH_14 14
#define INDEX_ADMPLEX_CH_15 15
// ----------------------------------------------------------------------------------------
// Volcanos.
// ----------------------------------------------------------------------------------------
